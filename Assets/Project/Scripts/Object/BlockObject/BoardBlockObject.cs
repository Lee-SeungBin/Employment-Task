...
public class BoardBlockObject : MonoBehaviour
{
    ...
    //                 if (!_ctrl.boardModel.CheckCanDestroy(this, block)) return false;
    ...
    //     
    //             bool isRight = isHorizon[i] ? y < _ctrl.boardModel.BoardHeight / 2 : x < _ctrl.boardModel.BoardWidth / 2;
    //             if (!isRight) length *= -1;
    ...
    //             ParticleSystem[] pss = BoardPresenter.Instance.BoardView.DestroyParticlePrefab
    //                 .GetComponentsInChildren<ParticleSystem>();
    //             foreach (var ps in pss)
    //             {
    //                 ParticleSystemRenderer psrs = ps.GetComponent<ParticleSystemRenderer>();
    //                 psrs.material = BoardPresenter.Instance.BoardView.GetTargetMaterial((int)block.colorType);
    //             }
    //     
    //             //TODO : Move to Other Class & Adjust Direction / Position
    //     
    //             ParticleSystem particle = Instantiate(BoardPresenter.Instance.BoardView.DestroyParticlePrefab,
    ...
    //     
    //     if (x == 0 && y == _ctrl.boardModel.BoardHeight)
    //         return isHorizon ? LaunchDirection.Up : LaunchDirection.Left;
    //     
    //     if (x == _ctrl.boardModel.BoardWidth && y == 0)
    //         return isHorizon ? LaunchDirection.Down : LaunchDirection.Right;
    //     
    //     if (x == _ctrl.boardModel.BoardWidth && y == _ctrl.boardModel.BoardHeight)
    ...
    //         return isHorizon ? LaunchDirection.Down : LaunchDirection.Left;
    //     
    //     if (x == _ctrl.boardModel.BoardWidth)
    //         return isHorizon ? LaunchDirection.Down : LaunchDirection.Right;
    //     
    //     if (y == _ctrl.boardModel.BoardHeight)
    //         return isHorizon ? LaunchDirection.Up : LaunchDirection.Right;
    //
    //     // 기본값 (필요하다면)
